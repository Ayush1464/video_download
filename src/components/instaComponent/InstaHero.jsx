  ...
  return (
    <div className="w-full text-center">
      <h1 className="text-3xl md:text-4xl font-bold mb-6">
        Download Insta Videos Instantly
      </h1>
      <p className="text-lg mb-8 text-gray-600">
        Paste the Insta video link below to download in seconds.
      </p>

      <div className="max-w-2xl mx-auto flex flex-col md:flex-row items-center gap-4">
        <input
          type="text"
          placeholder="Enter Insta video URL"
          value={videoURL}
        ...
        <button
          ...
          className="w-full md:w-auto px-6 py-3 bg-pink-600 text-white rounded-lg hover:bg-pink-700 transition"
        >
